...
/* Replace this with your actual WhatsApp SVG if needed */
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden flex h-16 bg-white border-t-2 border-[#6DBFAA]">
        ...
        <a
          href="tel:7799376656"
          className="flex-1 flex items-center justify-center gap-2 font-dm text-sm font-medium text-primary border-r border-[#E8EEF4]"
        >
          <Phone size={16} />
          Call Now
        </a>
        ...
        <Link
          href="/contact"
          className="flex-1 flex items-center justify-center gap-2 font-dm text-sm font-medium text-white bg-primary"
        >
          <Calendar size={16} />
          Book Appointment
        </Link>
